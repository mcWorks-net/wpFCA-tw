...
<section class="Objectives py-[130px] lg:py-[90px]">
        <div class="container lg:narrowContent">
            ...
            <div class="objectives lg:mx-36 mb-20">
                 <h2 class="text-3xl mb-10 text-primary">Objectives</h2>
                 <div>
                    <p class="mx-10 text-xl font-semibold">
                        <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                    ...
                    <ul class="ml-16 leading-9 text-lg">
                        <li>
                            <i class="fa-regular text-xs fa-circle mr-3"></i>
            ...
            <div class="lg:mx-40">
                <div class="accordionItem bg-clrGray py-3 px-3 relative transition-all mb-4 text-lg">
                    <h3 class="font-bold text-md md:text-xl">Time Period</h3>
                    <ul>
                        <li>
                            <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                ...
                <div class="accordionItem bg-clrGray py-3 px-3 relative transition-all mb-4 text-lg">
                    <h3 class="font-bold text-md md:text-xl">Room and Board</h3>
                    <ul class="">
                        <li>
                            <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                ...
                <div class="accordionItem bg-clrGray py-3 px-3 relative transition-all mb-4 text-lg">
                    <h3 class="font-bold text-md md:text-xl">Minimum Qualifications</h3>
                    <ul>
                        <li>
                            <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                ...
                <div class="accordionItem bg-clrGray py-3 px-3 relative transition-all mb-4 text-lg">
                    <h3 class="font-bold text-md md:text-xl">Other Ministry Opportunities</h3>
                    <ul>
                        <li>
                            <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                        ...
                        <li>
                            ...
                            Church Services (there are 18 campuses) on Saturdays and Sundays
                        </li>
                        <li>
                            <i class="fa-solid fa-circle text-xs text-primary mr-3"></i>
                            Small group involvement
